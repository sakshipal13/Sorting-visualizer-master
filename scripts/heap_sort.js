...
function max_heapify(n,i)
{
    ...
    if(l<n && div_sizes[l]>div_sizes[largest])
    {
        ...
        div_update(divs[largest],div_sizes[largest],"#4B0082");//Color update
    }
    ...
    if(r<n && div_sizes[r]>div_sizes[largest])
    {
        ...
        div_update(divs[largest],div_sizes[largest],"#4B0082");//Color update, purple
    }
...
function heap_sort()
{
    ...
    for(var i=array_size-1;i>0;i--)
    {
        ...
        div_update(divs[i],div_sizes[i],"#FF69B4");//Color update, yellow
